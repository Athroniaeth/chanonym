...
None of these cases concerns an LLM specifically. But they establish three facts:

- states regularly surveil the communications of journalists, lawyers and political figures
- the legal and technical tools to do so already exist
- an LLM that sees a law firm's conversations, an investigative newsroom's work, or an activist movement's messages becomes, by construction, a concentration point for high-value information
...
|--------------------------------|---------------------------------------|--------------------------------------------|---------------------------------|-----------------------------------------------------------------------|-------------------------------------------------|
| US provider, US servers        | Yes, directly                         | Indirect (via DPF, fragile)                | Yes                             | Variable (free, often a buried opt-out. Paid, excluded by default)      | OpenAI, Anthropic, Google                       |
